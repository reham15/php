...
if(isset($_GET["search"]))
{
  ...
  { $name=$_GET["product"];
    $all_requrds = Capsule::table("items")->where("product_name","like","$name")->get();
  }
  else
    echo "enter name";
...
$next_link = "http://127.0.0.1/php/lab4/index.php?index=$next_index";
$previous_index = (($index - _Pager_size_)>=0)?$index - _Pager_size_:0;
$previous_link = "http://127.0.0.1/php/lab4/index.php?index=$previous_index";
}
